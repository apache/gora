...
/**
 * Maintains mapping between AVRO data bean and ArangoDB document.
 */
public class ArangoDBMapping {

  public static final Logger log = LoggerFactory.getLogger(ArangoDBMapping.class);
  ...
  public void registerClassField(String classFieldName,
    ...
    try {
      ...
      throw new IllegalStateException("Declared '" + fieldType
              ...
              + "' is not supported by ArangoDBMapping");
    }
