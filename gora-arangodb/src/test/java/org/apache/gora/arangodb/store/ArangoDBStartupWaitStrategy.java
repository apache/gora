...
public class ArangoDBStartupWaitStrategy extends GenericContainer.AbstractWaitStrategy {
  ...
  protected void waitUntilReady() {
    ...
    try {
      ...
      throw new ContainerLaunchException(
              "Timed out waiting for log output matching ArangoDB server startup Log  \'" + regEx + "\'");
    }
  }
}