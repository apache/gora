...
public class HazelcastGoraDataStoreTest extends DataStoreTestBase {

  private static final Logger LOG = LoggerFactory.getLogger(HazelcastGoraDataStoreTest.class);
