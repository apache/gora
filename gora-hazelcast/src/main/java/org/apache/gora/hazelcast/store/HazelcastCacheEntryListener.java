...
/**
 * {@link HazelcastCacheEntryListener} is the primary class
 ...
 */
public class HazelcastCacheEntryListener<K, T extends PersistentBase>
  ...
  private static final Logger LOG = LoggerFactory.getLogger(HazelcastCacheEntryListener.class);
  private ConcurrentSkipListSet<K> cacheEntryList;

  public HazelcastCacheEntryListener(ConcurrentSkipListSet cacheEntryList) {
